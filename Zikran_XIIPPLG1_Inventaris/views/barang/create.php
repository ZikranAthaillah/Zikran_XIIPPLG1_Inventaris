...
<div class="mb-6">
    ...
    <p class="text-gray-600">Tambahkan barang baru ke inventaris</p>
</div>

<div class="bg-white rounded-xl shadow-md p-6">
    <form id="barangForm" action="index.php?page=barang&action=create" method="POST">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="number" id="harga" name="harga" min="0" step="100" value="0"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                       required>
